...
- [src/keysc/keydown_any.c](https://github.com/ClasspadDev/gint/blob/dev/src/keysc/keydown_any.c)
...
- [src/keysc/keydown_all.c](https://github.com/ClasspadDev/gint/blob/dev/src/keysc/keydown_all.c)
- [src/keysc/scan_frequency.c](https://github.com/ClasspadDev/gint/blob/dev/src/keysc/scan_frequency.c)
- [src/keysc/keycodes.c](https://github.com/ClasspadDev/gint/blob/dev/src/keysc/keycodes.c)
